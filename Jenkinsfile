podTemplate(label: 'buildpod',
    ...
    containers: [
        containerTemplate(name: 'docker', image: '172.16.1.1:8500/default/docker:latest', command: 'cat', ttyEnabled: true),
        containerTemplate(name: 'containertest', image: '172.16.1.1:8500/default/containertest:latest', command: 'cat', ttyEnabled: true),
        containerTemplate(name: 'helm', image: '172.16.1.1:8500/default/k8s-helm:latest', command: 'cat', ttyEnabled: true)
  ]) {
